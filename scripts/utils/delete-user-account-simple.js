...
/**
 * Script simplificado para deletar completamente uma conta de usuário
 * Remove todos os dados relacionados do banco de dados
 */
...
async function main() {
  ...
  switch (command) {
    case 'delete':
      const userId = args[1];
      if (!userId) {
        console.error('❌ Uso: node delete-user-account-simple.js delete <userId>');
        process.exit(1);
      }
    ...
    default:
      ...
      console.log('    node delete-user-account-simple.js list');
      console.log('');
      console.log('  Deletar conta de usuário:');
      console.log('    node delete-user-account-simple.js delete <userId>');
      console.log('');
